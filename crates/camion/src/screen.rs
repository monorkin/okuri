...
use camion_core::{Details, Ownership, Served, Stored};
use camion_engine::{Attempt, Concern, Connection, Event, SessionId};
...
impl Screen {
    ...
    /// not. Anything naming a file to something outside Camion needs the whole path.
...
mod tests {
    ...
    /// `/home/camion/photos`. Presenting the first as though it were the second is how somebody
    ...
    fn where_a_folder_is_on_the_server_is_not_where_the_window_says_it_is() {
        ...
        assert_eq!(screen.absolute_path(), "/home/camion/photos");
    }
    ...
    fn a_window_ignores_the_other_windows_connection() {
        ...
        assert_eq!(ours.home, "/home/camion");
        assert_eq!(ours.path(), "/");
    }
    ...
    #[test]
    fn a_problem_with_camion_itself_is_every_windows_news() {
        let mut ours = connected(Capabilities::filesystem());
