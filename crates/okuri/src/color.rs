...
///
/// Okuri only ever needs to read a palette and blend between two of its colours — separators
...
impl Color {
    ...
    /// Accepts `#rgb`, `#rrggbb`, and `#rrggbbaa`. Alpha is dropped: every surface Okuri
